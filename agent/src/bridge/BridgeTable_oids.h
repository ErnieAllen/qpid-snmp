...
#define COLUMN_brokerBRIDGENAME         2
#define COLUMN_brokerBRIDGENAME_FLAG    (0x1 << 1)

#define COLUMN_brokerBRIDGECHANNELID         3

#define COLUMN_brokerBRIDGEDURABLE         4
#define COLUMN_brokerBRIDGEDURABLE_FLAG    (0x1 << 2)

#define COLUMN_brokerBRIDGESRC         5
#define COLUMN_brokerBRIDGESRC_FLAG    (0x1 << 3)

#define COLUMN_brokerBRIDGEDEST         6
#define COLUMN_brokerBRIDGEDEST_FLAG    (0x1 << 4)

#define COLUMN_brokerBRIDGEKEY         7
#define COLUMN_brokerBRIDGEKEY_FLAG    (0x1 << 5)

#define COLUMN_brokerBRIDGESRCISQUEUE         8
#define COLUMN_brokerBRIDGESRCISQUEUE_FLAG    (0x1 << 6)

#define COLUMN_brokerBRIDGESRCISLOCAL         9
#define COLUMN_brokerBRIDGESRCISLOCAL_FLAG    (0x1 << 7)

#define COLUMN_brokerBRIDGETAG         10
#define COLUMN_brokerBRIDGETAG_FLAG    (0x1 << 8)

#define COLUMN_brokerBRIDGEEXCLUDES         11
#define COLUMN_brokerBRIDGEEXCLUDES_FLAG    (0x1 << 9)

#define COLUMN_brokerBRIDGEDYNAMIC         12
#define COLUMN_brokerBRIDGEDYNAMIC_FLAG    (0x1 << 10)

#define COLUMN_brokerBRIDGESYNC         13
#define COLUMN_brokerBRIDGESYNC_FLAG    (0x1 << 11)

#define COLUMN_brokerBRIDGEINTERNALINDEX         14
